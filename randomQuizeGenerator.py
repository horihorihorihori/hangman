...
#問題のデータ
capitals = {'北海道':'札幌','青森県':'青森市','岩手県':'盛岡市',
...
for quiz_num in range(35):
        quiz_file = open('/home/user01/Desktop/quiz/capitalsquiz{}.txt'.format(quiz_num + 1),'w')
        answer_key_file = open('/home/user01/Desktop/quiz/capitalsquiz_answers{}.txt'.format(quiz_num + 1),'w')
